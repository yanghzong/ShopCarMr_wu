...
public class MyAdapter extends BaseExpandableListAdapter{
    ...
    private MyAddJian myAdd;
    private TextView tvSunPrice;
    private TextView tvSunName;
    private ImageView imgShow;
    private CheckBox cbSun;

    public MyAdapter(List<ShopBean.DataBean> sellerData, Context context) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        //赋值
        ShopBean.DataBean dataBean = sellerData.get(groupPosition);
        //商家的姓名
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
       ...
       //赋值
        ShopBean.DataBean.ListBean listBean = sellerData.get(groupPosition).getList().get(childPosition);
    ...
    public double calculateTotalPrice() {
        ...
        for (int i = 0; i < sellerData.size(); i++) {
            List<ShopBean.DataBean.ListBean> list = sellerData.get(i).getList();
    ...
    public boolean isCurrentSellerAllProductSelected(int position) {
        List<ShopBean.DataBean.ListBean> list = sellerData.get(position).getList();
